...
import com.dptablo.template.springboot.kafka.CustomJsonDeserializer;
import com.dptablo.template.springboot.kafka.CustomJsonSerializer;
...
public class KafkaConfiguration {
    ...
    public Map<String, Object> consumerConfigMap() {
        ...
        configMap.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, CustomJsonDeserializer.class);
        return configMap;
    }
